...
import { ArrowRightIcon, ServiceModelIcon } from '../components/icons';
...
const RedactionPage: React.FC = () => {
  const features = [
    ...
    },
    {
      ...
      description: 'Original documents are automatically wiped from blob storage once the redacted version is delivered to you.'
    },
    {
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: 'Advanced AI identifies and redacts PII, SSN, credit cards, addresses, phone numbers, and custom sensitive data patterns.'
    },
    {
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: 'Redact sensitive information from PDF, Word, Excel, images, and scanned documents with equal accuracy.'
    },
    {
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: 'Real-time processing with no queue delays. Get your redacted documents in seconds, not minutes.'
    },
    {
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: 'GDPR, HIPAA, CCPA compliant. Built for industries with strict data privacy requirements.'
    }
  ];
  ...
  const processSteps = [
    ...
    },
    {
      number: '02',
      title: 'AI Processing',
      description: 'Our AI engine analyzes the document in real-time, identifying all sensitive data. No storage, only processing in backend.',
      icon: (
        <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: 'Sensitive data is permanently redacted. Choose between black boxes, blur, or custom patterns for maximum security.',
      icon: (
        <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: 'Receive your redacted document instantly. Original file is immediately deleted from blob storage. No traces left.',
      icon: (
        <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  const securityFeatures = [
    ...
    {
      title: 'No Logging of Document Content',
      description: 'We log metadata for functionality, but never the actual content of your documents.'
    }
  ];
  ...
  const useCases = [
    {
      icon: '🏥',
      title: 'Healthcare',
      description: 'Redact patient information, medical records, and HIPAA-protected data before sharing.'
    },
    {
      icon: '⚖️',
      title: 'Legal',
      description: 'Protect attorney-client privilege and sensitive case information in legal documents.'
    },
    {
      icon: '🏦',
      title: 'Financial',
      description: 'Remove account numbers, SSNs, and financial data from documents before distribution.'
    },
    {
      icon: '🏢',
      title: 'Enterprise',
      description: 'Clean documents for external sharing while maintaining internal confidentiality.'
    }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-neutral-50">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl md:text-2xl text-white/80 mb-2 leading-relaxed">
                Remove Sensitive Data Automatically with Zero Data Retention
              </p>
              <p className="text-lg text-white/70 mb-8">
                Upload, process, redact, deliver - then everything gets deleted. No storage, no traces, complete privacy.
              </p>
              ...
              <div className="w-full h-64 sm:h-80 lg:h-96 bg-white/10 rounded-2xl backdrop-blur-sm border border-white/20 flex items-center justify-center p-8">
                <div className="space-y-4 w-full">
                  <div className="bg-white/20 rounded-lg p-4 backdrop-blur-sm">
                    ...
                    <div className="h-3 bg-red-500/60 rounded w-2/3"></div>
                  </div>
                  ...
                  <div className="bg-white/20 rounded-lg p-4 backdrop-blur-sm">
                    <div className="h-3 bg-white/40 rounded w-3/4 mb-2"></div>
                    <div className="h-3 bg-white/40 rounded w-1/2 mb-2"></div>
                    <div className="h-3 bg-black/80 rounded w-2/3"></div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-neutral-300 max-w-3xl mx-auto">
              Your data security is our top priority. Here's our iron-clad privacy commitment:
            </p>
          </div>
            ...
            {securityFeatures.map((feature, index) => (
              <div key={index} className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10 hover:bg-white/10 transition-all duration-300">
                <div className="flex items-start gap-4">
                  <svg className="w-6 h-6 text-primary/60 flex-shrink-0 mt-1" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="mt-12 text-center">
            <div className="inline-flex items-center gap-3 px-6 py-4 bg-primary/20 rounded-lg border border-primary/30">
              <svg className="w-8 h-8 text-primary/60" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
              </svg>
              <p className="text-lg font-semibold">
                Automatic deletion within <span className="text-white">5 seconds</span> of document transfer
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-neutral-600 max-w-3xl mx-auto">
            Enterprise-grade redaction with consumer-friendly privacy
          </p>
        </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {useCases.map((useCase, index) => (
              <div 
                key={index}
                className="bg-white rounded-2xl p-6 shadow-md hover:shadow-xl transition-all duration-300 border border-neutral-100 hover:border-primary/30"
              >
        ...
        <div className="bg-primary rounded-3xl p-12 text-center text-white relative overflow-hidden">
          ...
          <div className="relative z-10">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              Ready to Redact Your Documents Securely?
            </h2>
            <p className="text-xl text-white/80 mb-8 max-w-2xl mx-auto">
              Start protecting sensitive data today. No storage, no traces, complete privacy.
            </p>
