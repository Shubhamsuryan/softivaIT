...
const AWSTextractPage: React.FC = () => {
  return (
    <div className="bg-accent">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-24">
            <h1 className="text-4xl md:text-5xl font-extrabold text-neutral-900 text-center">AWS Textract</h1>
            <p className="mt-6 max-w-3xl mx-auto text-xl text-neutral-600 text-justify">
                A machine‑learning service with APIs that extract text, forms and tables from varied documents using deep learning, with synchronous and asynchronous operations for single‑page or multipage files. Use cases include search indexing, NLP and automated form processing.
            </p>
        </div>
...
export default AWSTextractPage;