...
const AzureDocumentIntelligencePage: React.FC = () => {
  return (
    <div className="bg-accent">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-24">
            <h1 className="text-4xl md:text-5xl font-extrabold text-neutral-900 text-center">Azure Document Intelligence</h1>
            <p className="mt-6 max-w-3xl mx-auto text-xl text-neutral-600 text-justify">
                Uses machine learning to extract text, key‑value pairs and tables from documents. It combines OCR and prebuilt models for invoices, receipts, business cards and more. Outputs structured JSON with confidence scores and supports custom models for diverse document types.
            </p>
        </div>
...
export default AzureDocumentIntelligencePage;